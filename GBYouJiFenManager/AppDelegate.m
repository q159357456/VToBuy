...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //设置友盟appkey
    [[UMSocialManager defaultManager] setUmSocialAppkey:@"59ed9e38c62dca79a8000975"];
    //设置微信的appKey和appSecret
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_WechatSession appKey:@"wx818f4527e172ead3" appSecret:@"aa1845c5d676575b6d384b4178870849" redirectURL:@"http://mobile.umeng.com/social"];
 
    //向微信注册 wxc3634aeb0c228038
    [WXApi registerApp:@"wx818f4527e172ead3"];
    ...
    BOOL ret = [_mapManager start:@"Kr2tkqyk9wkDEk4rYnhmMhpLyphdmn5o" generalDelegate:self];
    if (!ret) {
    ...
    //.navBarBarTintColor = [UIColor whiteColor];

...
-(void)creatTable
{
    ...
    {
        _tableview4=[[UITableView alloc]initWithFrame:CGRectMake(0, screen_height-limitHeight-55-64, _coverView.width,limitHeight) style:UITableViewStylePlain];
        
    }else
    {
        _tableview4=[[UITableView alloc]initWithFrame:CGRectMake(0, screen_height-[self retrunTableRowHeight]-headerHeight-55-64, _coverView.width, [self retrunTableRowHeight]+headerHeight) style:UITableViewStylePlain];
    }
        ...
        _tableview4.userInteractionEnabled=YES;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    }else if(tableView==_tableview3)
    {
       ...
       //获取数量
        ...
        cell.pluseBlock=^(UIImageView *headImage,UIButton *butt){
...
-(void)chanegeTableFrame
{
    ...
    {
          _tableview4.frame=CGRectMake(0, _coverView.height-[self retrunTableRowHeight]-headerHeight-55-64, _coverView.width, [self retrunTableRowHeight]+headerHeight);
    }

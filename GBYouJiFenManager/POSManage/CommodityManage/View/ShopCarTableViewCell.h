...
@property (strong, nonatomic) IBOutlet UILabel *rLable;
@property (strong, nonatomic) IBOutlet UIButton *minceButt;
@property (strong, nonatomic) IBOutlet UIButton *pluseButt;

...
-(instancetype)initWithDateStyle:(WSDateStyle)datePickerStyle CompleteBlock:(void(^)(NSDate *))completeBlock {
    ...
    if (self) {
        ...
        switch (datePickerStyle) {
            case zwhDateStyleShowYearMonthDayHourMinute:
                _dateFormatter = @"yyyy-MM-dd HH:mm";
                break;
            case zwhDateStyleShowMonthDayHourMinute:
                _dateFormatter = @"yyyy-MM-dd HH:mm";
                break;
            case zwhDateStyleShowYearMonthDay:
                _dateFormatter = @"yyyy-MM-dd";
                break;
            case zwhDateStyleShowYearMonth:
                _dateFormatter = @"yyyy-MM";
                break;
            case zwhDateStyleShowMonthDay:
                _dateFormatter = @"yyyy-MM-dd";
                break;
            case zwhDateStyleShowHourMinute:
...
- (void)getNowDate:(NSDate *)date animated:(BOOL)animated
{
    ...
    if (self.datePickerStyle == zwhDateStyleShowYearMonthDayHourMinute)
        indexArray = @[@(yearIndex),@(monthIndex),@(dayIndex),@(hourIndex),@(minuteIndex)];
    if (self.datePickerStyle == zwhDateStyleShowYearMonthDay)
        indexArray = @[@(yearIndex),@(monthIndex),@(dayIndex)];
    if (self.datePickerStyle == zwhDateStyleShowYearMonth)
        indexArray = @[@(yearIndex),@(monthIndex)];
    if (self.datePickerStyle == zwhDateStyleShowMonthDayHourMinute)
        indexArray = @[@(monthIndex),@(dayIndex),@(hourIndex),@(minuteIndex)];
    if (self.datePickerStyle == zwhDateStyleShowMonthDay)
        indexArray = @[@(monthIndex),@(dayIndex)];
    if (self.datePickerStyle == zwhDateStyleShowHourMinute)
    ...
    for (int i=0; i<indexArray.count; i++) {
        if ((self.datePickerStyle == zwhDateStyleShowMonthDayHourMinute || self.datePickerStyle == zwhDateStyleShowMonthDay)&& i==0) {

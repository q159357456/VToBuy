 ...
 */
typedef enum{
    zwhDateStyleShowYearMonthDayHourMinute  = 0,//年月日时分
    zwhDateStyleShowMonthDayHourMinute,//月日时分
    zwhDateStyleShowYearMonthDay,//年月日
    zwhDateStyleShowYearMonth,//年月
    zwhDateStyleShowMonthDay,//月日
    zwhDateStyleShowHourMinute//时分

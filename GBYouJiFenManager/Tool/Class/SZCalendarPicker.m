...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    }else
    {
        ...
        SZCalendarCell *cell=(SZCalendarCell*)[_collectionView cellForItemAtIndexPath:_MyIndexPath];
              cell.dateLabel.textColor=[UIColor colorWithHexString:@"#6f6f6f"];
          
        }
        SZCalendarCell *cell=(SZCalendarCell*)[_collectionView cellForItemAtIndexPath:indexPath];

...
- (void)loadBaseUI{
    self.title = @"创建套餐";
    _headScrollView = [[UIView alloc]initWithFrame:CGRectMake(0, 64, [UIScreen mainScreen].bounds.size.width,50)];
...
//    _headScrollView.showsVerticalScrollIndicator = NO;
    ...
    _contentView = [[UIView alloc]initWithFrame:CGRectMake(0, 114, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 50 - 64)];

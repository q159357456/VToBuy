...
- (IBAction)done:(UIButton *)sender
{
    ...
    jsonDic=@{ @"Command":@"Edit",@"TableName":@"INV_MallProduct",@"Data":@[@{@"COMPANY":model.COMPANY,@"SHOPID":model.SHOPID,@"ProductNo":self.model.ProductNo,@"InventoryQty":self.model.InventoryQty,@"E_BatchQty":self.model.E_BatchQty,@"IsUpDown":self.model.IsUpDown}]};
